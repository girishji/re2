...
This package provides R functions that operate on strings using regular expressions. The interface is similar to [stringr](https://github.com/tidyverse/stringr) package, and the functionality covers *grep*, *regex*, and *sub* family of base R. The implementation is based on Google's [RE2](https://github.com/google/re2) (C++) regular-expression library.
